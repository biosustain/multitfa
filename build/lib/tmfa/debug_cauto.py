...
CO.lower_bound = -0.004 #-0.03156
CO.upper_bound = -0.004 #-0.02957

H2 = model.reactions.get_by_id('EX_H2[c]')
H2.lower_bound = -0.112#-0.0129
H2.upper_bound = -0.112#-0.0131

CO2 = model.reactions.get_by_id('EX_Co2[c]')
CO2.lower_bound = -0.042#0.01223
CO2.upper_bound = -0.042#0.01291

acetate = model.reactions.get_by_id('EX_acetate[e]')
acetate.lower_bound = 0.00945#0.0039
acetate.upper_bound = 0.00945#0.0042

ethanol = model.reactions.get_by_id('DM_Ethanol[c]')
ethanol.lower_bound = 0.01144#0.00337
ethanol.upper_bound = 0.01144#0.0036
"""
