from .sampling_util import generate_constraints_sample, generate_ellipsoid_sample, stddev_sampling_rhs, compare_dataframes, extreme_value_distribution
...
def cutoff_sampling(model, cutoff = 100):
    """[summary]
...
def gev_sampling(model, cutoff = 1000):
    """[summary]
